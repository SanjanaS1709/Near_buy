...
class _ShopDashboardScreenState extends State<ShopDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_shop == null) return Scaffold(
      appBar: AppBar(title: const Text("Local Bazaar"), backgroundColor: Colors.transparent, elevation: 0),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const Text("No shop profile found.\nPlease register a shop first.", textAlign: TextAlign.center, style: TextStyle(fontSize: 18)),
            const SizedBox(height: 24),
            ElevatedButton(
              onPressed: () => Navigator.pop(context),
              style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFA50000)),
